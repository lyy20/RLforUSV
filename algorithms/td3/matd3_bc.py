...
class MATD3_BC:
    def __init__(self, num_agents = 3, num_landmarks = 1,num_obstacles = 3, landmark_depth=15., discount_factor=0.95, tau=0.02, lr_actor=1.0e-2, lr_critic=1.0e-2, weight_decay=1.0e-5, device = 'cpu', rnn = True, dim_1=64, dim_2=32):
        ...
        in_actor = 1 * 2 * 2 + num_landmarks * 2 + (
                num_agents - 1) * 2 + num_landmarks + 1 * num_landmarks + 2 + 1 + 2 * num_obstacles + num_obstacles + num_obstacles
